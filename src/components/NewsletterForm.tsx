  ...
  if (submitted) {
    return (
      <div className="flex items-center justify-center gap-3 py-3">
        ...
        <p className={`font-semibold text-sm ${variant === "footer" ? "text-white" : "text-teal-500"}`}>
    ...
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
      <div className="relative flex-1">
        ...
        <input
          ...
          className={[
            ...
            "hover:border-teal-200 hover:shadow-md hover:shadow-teal-50",
            "focus:border-teal-400 focus:outline-none focus:shadow-lg focus:shadow-teal-50",
            "transition-all duration-200",
            "shadow-sm",
          ].join(" ")}
        />
      ...
      <button
        ...
        className={[
          ...
          "hover:from-teal-300 hover:to-teal-400 hover:shadow-xl hover:shadow-teal-500/40 hover:-translate-y-0.5",
          "active:translate-y-0 active:shadow-md",
          "disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none",
          "transition-all duration-200",
        ].join(" ")}
