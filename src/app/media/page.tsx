...
export default function MediaPage() {
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-green-300 text-lg leading-relaxed mb-8">
            ...
            <div className="relative h-80 lg:h-[460px] rounded-3xl overflow-hidden bg-gradient-to-br from-green-700 to-green-900 shadow-2xl">
              <FadeImage
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4">
                <p className="font-bold text-green-900">Dr. Genevieve Ufongene, DNP, FNP-C</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {mediaTypes.map((type) => (
              <div key={type.title} className="text-center p-6 bg-green-50 rounded-2xl border border-green-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={i}
                className="relative h-56 rounded-2xl overflow-hidden bg-gradient-to-br from-green-700 to-green-900 shadow-md"
              >
                <FadeImage
                  src={photo.src}
                  alt={photo.label}
      ...
      {/* Booking Section */}
      <section id="booking" className="py-20 bg-green-900 text-white">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form className="space-y-5 bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <label className="block text-green-200 text-sm font-medium mb-2">Name *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-green-200 text-sm font-medium mb-2">Organization</label>
                <input
                  type="text"
                  className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-amber-400 text-sm"
            ...
            <div>
              <label className="block text-green-200 text-sm font-medium mb-2">Email *</label>
              <input
                type="email"
                required
                className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-amber-400 text-sm"
            ...
            <div>
              <label className="block text-green-200 text-sm font-medium mb-2">Type of Engagement *</label>
              <select
                required
            ...
            <div>
              <label className="block text-green-200 text-sm font-medium mb-2">Event Details</label>
              <textarea
                rows={4}
